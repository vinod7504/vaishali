...
const translations = {
  te: {
    ...
    designContactEyebrow: "డిజైనింగ్ సేవలు",
    designContactTitle: "వెబ్‌సైట్ మరియు ప్రింట్ డిజైనింగ్ కావాలా?",
    designContactIntro: "వివాహాలు, బ్రోచర్లు, మెనూ కార్డులు, ఆహ్వాన పత్రికలు మరియు వ్యాపార ప్రచారం కోసం ఆకర్షణీయమైన డిజైన్లు అందుబాటులో ఉన్నాయి.",
    serviceWebsites: "వివాహాలు మరియు వ్యాపారాల కోసం వెబ్‌సైట్లు",
    serviceBrochures: "బ్రోచర్లు, పోస్టర్లు మరియు ఫ్లెక్స్ డిజైన్లు",
    serviceCards: "ఆహ్వాన పత్రికలు, మెనూ కార్డులు మరియు బిజినెస్ కార్డులు",
    contactLabel: "సంప్రదించండి",
    contactOwner: "Prop: B. Vinod Kumar (B-Tech)",
  ...
  en: {
    ...
    designContactEyebrow: "Designing Services",
    designContactTitle: "Need Website or Print Designing?",
    designContactIntro: "Attractive designs are available for marriages, brochures, menu cards, invitations, and business promotions.",
    serviceWebsites: "Websites for marriages and businesses",
    serviceBrochures: "Brochures, posters, and flex designs",
    serviceCards: "Invitations, menu cards, and business cards",
...
function renderStaticText() {
  ...
  const textTargets = {
    ...
    "#designContactEyebrow": copy.designContactEyebrow,
    "#designContactTitle": copy.designContactTitle,
    "#designContactIntro": copy.designContactIntro,
    "#serviceWebsites": copy.serviceWebsites,
    "#serviceBrochures": copy.serviceBrochures,
    "#serviceCards": copy.serviceCards,
    "#contactLabel": copy.contactLabel,
    "#contactOwner": copy.contactOwner,
